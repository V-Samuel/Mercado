...
<div class="bg-white p-6 rounded-2xl shadow-md max-w-lg">
    ...
    <form action="{{ route('admin.categorias.update', $categoria) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="descricao" type="text" name="descricao" value="{{ old('descricao', $categoria->descricao) }}" required>
        </div>
