...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <details class="group text-gray-500 text-sm mt-2">
                        <summary class="flex items-center font-semibold cursor-pointer list-none text-gray-800">
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <svg class="transition-transform group-open:rotate-180" fill="none" height="24"
                        ...
                        <div
                            class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 ease-in-out group-open:grid-rows-[1fr] group-open:opacity-100 group-open:mt-2">
        ...
        <div
            class="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
            <div>
                <a href="{{ route('admin.produtos.index') }}">
                    ...
                    <details class="group text-gray-500 text-sm mt-2">
                        ...
                        <div
                            ...
                            <div class="overflow-hidden">
                                ...
                                @foreach ($produtosAbaixoEstoqueMinimo as $produto)
            ...
            <a href="{{ route('admin.produtos.index') }}">
                <div
                    class="p-3 rounded-full {{ $produtosAbaixoEstoqueMinimoCount > 0 ? 'bg-red-200 text-red-600' : 'bg-yellow-100 text-yellow-600' }}">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
