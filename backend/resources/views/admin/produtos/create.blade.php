...
<div class="bg-white p-6 rounded-2xl shadow-md max-w-lg">
    <h2 class="text-xl font-semibold mb-4 text-gray-800">Novo Produto</h2>
    ...
    <form action="{{ route('admin.produtos.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="valor_unidade_medida" type="number" step="0.01" name="valor_unidade_medida" value="{{ old('valor_unidade_medida') }}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="data_validade" type="date" name="data_validade" value="{{ old('data_validade') }}">
        </div>
        <div class="mb-4">
