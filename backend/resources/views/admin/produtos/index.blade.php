    ...
    <table class="min-w-full w-full table-auto border-collapse">
        ...
        <thead class="hidden md:table-header-group">
            <tr class="bg-gray-200 text-gray-600 uppercase text-base leading-normal">
                ...
                <th class="py-3 px-6 text-left">Custo</th>
                <th class="py-3 px-6 text-left">Venda</th>
                <th class="py-3 px-6 text-left">Estoque</th>
                <th class="py-3 px-6 text-left">Mínimo</th>
        ...
        <tbody class="text-gray-600 text-lg font-light block md:table-row-group">
            ...
            <tr class="block md:table-row">
                <td colspan="9" class="py-3 px-6 text-center text-gray-500 block md:table-cell bg-white rounded-lg shadow-sm">
