    ...
    <div className="min-h-screen bg-slate-950 text-white selection:bg-blue-500/30 overflow-hidden font-sans">
      ...
      <nav className="fixed w-full z-50 top-0 bg-slate-950/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-blue-700 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/30">
          ...
          <div className="flex items-center gap-4">
            <a href={`${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://127.0.0.1:8000'}/admin/login`} className="hidden md:block text-sm font-medium text-slate-300 hover:text-white transition-colors">Entrar</a>
            <a href={`${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://127.0.0.1:8000'}/admin/register`}><button className="bg-blue-600 hover:bg-blue-500 px-6 py-2.5 rounded-full text-sm font-semibold transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] active:scale-95">
              Começar Agora
            </button></a>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[-20%] left-[50%] translate-x-[-50%] w-200 h-100 rounded-[100%] bg-blue-600/20 blur-[120px]" />
        </div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="http://localhost:8000/demo/start" className="w-full sm:w-auto px-8 py-4 bg-white text-slate-950 hover:bg-slate-200 rounded-full font-bold text-lg transition-transform hover:scale-105 flex items-center justify-center gap-2 shadow-[0_0_100px_rgba(255,255,255,0.15)]">
      ...
      {/* Seção de Recursos */}
      <section className="py-24 bg-slate-900/40 border-y border-white/5 relative z-10">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="bg-slate-900/80 border border-slate-800 p-8 rounded-3xl hover:bg-slate-800/80 transition-colors group"
              >
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="bg-linear-to-br from-blue-900/40 via-slate-900 to-purple-900/40 border border-white/10 rounded-3xl p-8 md:p-16 text-center relative overflow-hidden">
            ...
            <a href={`${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://127.0.0.1:8000'}/admin/register`}>
